...
const ShopContextprovider = (props) => {
    ...
    const addtocart = async (itemid, size) => {
        ...
        if (token) {
            const res = await fetch("https://ecomm-backend-blond.vercel.app/api/cart/add", {
                method: "POST",
                headers: {
    ...
    const updatequantity = async (itemid, size, quantity) => {
        ...
        if (token) {
            const res = await fetch("https://ecomm-backend-blond.vercel.app/api/cart/remove", {
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                    token: token
    ...
    const getusercart = async () => {
        if (token) {
            const res = await fetch("https://ecomm-backend-blond.vercel.app/api/cart/get", {
                method: "POST",
                headers: {
    ...
    const getdata = async () => {
        ...
        const res = await fetch("https://ecomm-backend-blond.vercel.app/api/product/get", {
            method: "GET"
        })
